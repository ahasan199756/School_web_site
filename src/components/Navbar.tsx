        ...
        <div className="hidden md:flex items-center gap-1 p-1 rounded-2xl glass-morphism shadow-inner">
          {[
            ...
            >
              ...
              {/* Pulsing update dot for Notice */}
              {link.hasUpdate && <span className="notice-dot z-20" />}
              
              {/* Subtle slide-up background effect */}
        ...
        <div className="flex items-center gap-3">
          ...
          <div className="relative hidden lg:block group">
            ...
            <input
              ...
              className="h-9 w-40 xl:w-56 pl-9 pr-4 rounded-full border border-input bg-muted/20 focus:bg-background focus:w-64 focus:ring-2 ring-primary/20 outline-none transition-all text-sm"
            />
          </div>
